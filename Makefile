...
SRCS 	= cvodehse.f90 cvode_indices.f90 integrator.f90 physical_constants.f90 polytrope_eos.f90
OBJS	= $(SRCS:.f90=.o)
...
integrator.o : integrator.f90 polytrope_eos.mod cvodehse.mod cvode_indices.mod
	${F90} ${FFLAGS} -c $< -o $@
